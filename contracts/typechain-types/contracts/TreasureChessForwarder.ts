...
export interface TreasureChessForwarderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "eip712Domain"
      | "execute"
...
export interface TreasureChessForwarder extends BaseContract {
  connect(runner?: ContractRunner | null): TreasureChessForwarder;
  waitForDeployment(): Promise<this>;

  interface: TreasureChessForwarderInterface;
