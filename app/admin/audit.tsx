...
const FILTER_OPTIONS: FilterOption[] = [
  ...
  { label: "Balance", value: "user_balance_adjust", color: "#4CAF82" },
...
function getActionDetails(actionType: AdminActionType): ActionDetails {
  const actionMap: Record<AdminActionType, ActionDetails> = {
    ...
    user_balance_adjust: { icon: "cash", color: "#4CAF82", label: "Balance Adjusted" },
    ...
    manual_refund: { icon: "return-down-back", color: "#4CAF82", label: "Manual Refund" },
