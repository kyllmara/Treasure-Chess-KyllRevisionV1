-- Fix: g.result is type game_result (enum), but the function declares column 14 as TEXT.
-- Cast g.result to TEXT to match the declared return type.
